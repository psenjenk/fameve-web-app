                ...
                if($the_launcher_menu_layout == 'side_menu' || $the_launcher_menu_layout == ''){ ?>
            		<nav id="site-navigation" class="main-navigation <?php echo esc_attr($the_launcher_menu_layout); ?>" role="navigation">
                        <div id="side-menu-title">
                            <span><?php esc_html_e('Menu','the-launcher'); ?></span>
                        </div>
...
<div class="banner_timer <?php if($the_launcher_enable_slider_arrow){echo 'arrow-enable ';} echo esc_attr($the_launcher_slider_layout); if($the_launcher_form_category == ''){ echo 'slider-disable'; } ?>">
    <?php if ($the_launcher_form_query->have_posts() && $the_launcher_form_category) : 
        ...
        if (get_theme_mod('the_launcher_slider_counter_enable') || is_active_sidebar('the-launcher-subscribe-form')){ 
            $cls = '';
        }else{
            $cls = 'disable-counter-form';
        }
    ?>
    <div class="slider_content_wrap <?php  echo esc_attr($cls); ?>">
        ...
        ?>
        <a href="" id="arrow_left"><?php if(empty($the_launcher_enable_slider_arrow)){  esc_html_e('Next','the-launcher'); } ?></a>
        <a href="" id="arrow_right"><?php if(empty($the_launcher_enable_slider_arrow)){ esc_html_e('Prev','the-launcher'); } ?></a>
        <?php } ?>
     </div>      
<?php endif;?>
<div class="form_counter_wrap">
    <div class="ak-container clearfix">
        ...
        <div class="form_counter <?php if(!is_active_sidebar('the-launcher-subscribe-form')){ echo 'form_disable'; } if(get_theme_mod('the_launcher_slider_counter_enable') == '') { echo 'is_counter_disable'; }?>">
            ...
            <div class="launcher_form_counter">
                ...
                $the_launcher_week_text = get_theme_mod( 'the_launcher_week_text', esc_html__( 'Weeks', 'the-launcher' ) );
                $the_launcher_days_text = get_theme_mod( 'the_launcher_days_text', esc_html__( 'Days', 'the-launcher' ) );
                $the_launcher_hour_text = get_theme_mod( 'the_launcher_hour_text', esc_html__( 'Hours', 'the-launcher' ) );
                $the_launcher_minute_text = get_theme_mod( 'the_launcher_minute_text', esc_html__( 'Minutes', 'the-launcher' ) );
                $the_launcher_seconds_text = get_theme_mod( 'the_launcher_seconds_text', esc_html__( 'Seconds', 'the-launcher' ) );
                ?>
                    <div id="lwt-countdown-losange"><?php echo esc_html($the_launcher_day.'-'.$the_launcher_month.'-'.$the_launcher_year.'-'.$the_launcher_hour.'-'.$the_launcher_minut); ?></div>
                    <div id="countdown_dashboard">
            			<div id="day" class="dash weeks_dash">
            				<span class="dash_title"><?php echo esc_html( $the_launcher_week_text ); ?></span>
            				<div class="digit">0</div>
            				<div class="digit">0</div>
            			</div>
            
            			<div class="dash days_dash">
            				<span class="dash_title"><?php echo esc_html( $the_launcher_days_text ); ?></span>
            				<div class="digit">0</div>
            				<div class="digit">0</div>
            			</div>
            
            			<div class="dash hours_dash">
            				<span class="dash_title"><?php echo esc_html( $the_launcher_hour_text ); ?></span>
            				<div class="digit">0</div>
            				<div class="digit">0</div>
            			</div>
            
            			<div class="dash minutes_dash">
            				<span class="dash_title"><?php echo esc_html( $the_launcher_minute_text ); ?></span>
            				<div class="digit">0</div>
            				<div class="digit">0</div>
            			</div>
            
            			<div class="dash seconds_dash">
            				<span class="dash_title"><?php echo esc_html( $the_launcher_seconds_text ); ?></span>
            				<div class="digit">0</div>
            				<div class="digit">0</div>
            			</div>
