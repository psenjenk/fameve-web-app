...
<div class="empty_test"></div>
    <div class="ak-container clearfix">
        <div class="testimonial-posts">
                ...
                <div class="title_desc">
                    <div class="title_sub">
                        ...
                        if($the_launcher_section_title){
                            ?>
                                <span class="service_title wow fadeInUp"><?php echo esc_html($the_launcher_section_title); ?></span>
                            <?php
                        }
                        if($the_launcher_section_sub_title){
                            ?>
                                <span class="service_sub_title wow fadeInUp"><?php echo esc_html($the_launcher_section_sub_title); ?></span>
                            <?php
                        }
                        ?>
                    </div>
            ...
            <div class="bxslider_testimonial owl-carousel">
