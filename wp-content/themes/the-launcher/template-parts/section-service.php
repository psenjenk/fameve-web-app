        ...
        <?php if($the_launcher_service_title || $the_launcher_service_sub_title || $the_launcher_service_description){ ?>
            ...
            <?php if($the_launcher_service_title || $the_launcher_service_sub_title){ ?>
                ...
                <?php if($the_launcher_service_title){ ?>
                    <span class="service_title wow fadeInUp"><?php echo esc_html($the_launcher_service_title); ?></span>
                <?php }
                if($the_launcher_service_sub_title){
                    ?>
                        <span class="service_sub_title wow fadeInUp"><?php echo esc_html($the_launcher_service_sub_title); ?></span>
                    <?php } ?>
                </div>
            <?php }
                            ...
                            <div class="service_post_<?php echo esc_attr($the_launcher_post); ?>">
                                ...
                                <div class="service_post-inner-wrap">
                                    ...
                                    <div class="title_content_wrap">
                                        ...
                                        ?>
                                                <span class="service_title"><a href="<?php echo esc_url(get_permalink($the_launcher_service_post)); ?>"><?php echo esc_html($the_launcher_title_post); ?></a></span>
                                        <?php 
                                            }
                                            if($the_launcher_content_post){
                                        ?>
                                            <span class="service_content"><?php echo wp_kses_post(wp_trim_words($the_launcher_content_post,'10','...')); ?></span>
                                        <?php
                                            }
                                        ?>
                                    </div>
