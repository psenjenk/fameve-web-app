...
<div class="ak-container">  
        ...
        ?>
            ...
            ?>
                ...
                ?>
                    <span class="service_title wow fadeInUp"><?php echo esc_html($the_launcher_pricing_section_title); ?></span>
                <?php } 
                if($the_launcher_pricing_section_sub_title){
                ?>
                    <span class="service_sub_title wow fadeInUp"><?php echo esc_html($the_launcher_pricing_section_sub_title); ?></span>
                <?php } ?>
                </div>
            <?php } ?>
