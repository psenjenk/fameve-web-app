...
$the_launcher_add_section_arrays = array(
    ...
    'the_launcher_post_section'=>array(
        'id'=>'the_launcher_post_section',
        'args'=>array(
            'title'=>__('Post Setting','the-launcher'),
            'priority'=>5,
            'capability'=>'edit_theme_options',
            'theme_support'=>'',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'the_launcher_post_feat_img', array(
    'label'         => __( 'Check To Enable Feature Image', 'the-launcher' ),
    'section'       => 'the_launcher_post_section',
    'settings'      => 'the_launcher_post_feat_img',
    'type'          =>'checkbox'
) ) );

//meta data
$wp_customize->add_setting(
    'the_launcher_post_meta_data',
    array(
        'default'=>1,
        'sanitize_callback'=>'the_launcher_sanitize_checkbox'
    )
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'the_launcher_post_meta_data', array(
    'label'         => __( 'Check To Enable Meta Data', 'the-launcher' ),
    'section'       => 'the_launcher_post_section',
    'settings'      => 'the_launcher_post_meta_data',
    'type'          =>'checkbox'
) ) );

//post title
$wp_customize->add_setting(
    'the_launcher_post_title_enable',
    array(
        'default'=>1,
        'sanitize_callback'=>'the_launcher_sanitize_checkbox'
    )
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'the_launcher_post_title_enable', array(
    'label'         => __( 'Check To Enable Post Title', 'the-launcher' ),
    'section'       => 'the_launcher_post_section',
    'settings'      => 'the_launcher_post_title_enable',
    'type'          =>'checkbox'
) ) );
